...
Deployments into prexisting software infrastructures
Toggling features per client or environment
The size of the codebase and the rate at which refactors take place,
Supporting new polyfills and deprecating old ones
...
For the sake of brevity there is no need to compile images of any kind or polyfill old browsers - the goal is to simply demonstrate some basic webpack functionality without the help of tools like Create React App, Yeoman, etc.
During a production build it is nice to see optimized files
You will get bonus points for lazy loaded chunks